	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    javax.mail.Session mailSession = javax.mail.Session.getInstance(properties);
	     ...
	     try {	        	
	            ...
	            InternetAddress sender = new InternetAddress("jasneetkohli99@gmail.com","Inquiry:FromMyWebsite");
	            InternetAddress receiver = new InternetAddress("jasneetkohli99@gmail.com");
	            message.setFrom(sender);
	            message.setRecipient(Message.RecipientType.TO, receiver);
	            message.saveChanges();	            
	            javax.mail.Transport transport = mailSession.getTransport("smtp");
	            transport.connect("smtp.gmail.com", 587, "jasneetkohliportfolio@gmail.com", "Waheguru@9999");
